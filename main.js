                                ...
                                programs: [
                                    { 
                                        ...
                                        details: {
                                            ...
                                            "장비 및 영상 검사": [
                                                "흉부 X-선 (폐결핵, 폐렴, 심장비대 등)",
                                                "상복부 초음파 (간, 담낭, 췌장, 비장, 신장 질환)",
                                                "동맥경화도 검사 (혈관의 노화 및 탄력성 측정)"
                                            ],
                                            "정밀 혈액 검사 (기능별)": [
                                                "간기능 (AST, ALT, GGT, 알부민, 총단백 등 8종)",
                                                "신장기능 (BUN, Creatinine, 요산)",
                                                "췌장질환 (Amylase, Lipase)",
                                                "통풍 (요산)",
                                                "빈혈/혈액질환 (혈색소, 적혈구, 백혈구 등 24종)",
                                                "염증/류마티스 (CRP, RA factor 등)",
                                                "고지혈증 (총콜레스테롤, LDL, HDL, 중성지방)",
                                                "전해질/무기질 (나트륨, 칼륨, 칼슘, 무기인 등)",
                                                "혈당 (당뇨) (공복혈당, 당화혈색소)",
                                                "성병 (매독, 에이즈)",
                                                "B형 간염 (항원, 항체)"
                                            ],
                                            "암 표지자 검사 (Tumor Markers)": [
                                                "간암 (AFP)",
                                                "대장/소화기암 (CEA)",
                                                "췌장암 (CA19-9)",
                                                "전립선암 (PSA) / 난소암 (CA-125)"
                                            ...
                                            "기타 정밀": [
                                                "소변검사 (17종: 요단백, 요당, 요잠혈 등)",
                                                "비타민D 검사 (체내 비타민D 농도 측정)",
                                                "생활습관 가이드 (건강 상담 및 결과 판정)"
                                            ]
                                        }
                                    },
                                    { 
