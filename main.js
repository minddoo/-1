                                ...
                                programs: [
                                    { 
                                        ...
                                        details: {
                                            ...
                                            "혈액 검사": [
                                                "당뇨 검사 (당화혈색소(HbA1c) - 당뇨병)",
                                                "고지혈증 및 심혈관질환 검사 (총콜레스테롤, 중성지방, HDL-콜레스테롤, LDL-콜레스테롤, Homocysteine, hs-CRP - 고지혈증, 동맥경화, 심혈관질환 위험도 등)",
                                                "암 표시자(Tumor Maker) 검사 (AFP, CEA, CA19-9, PSA(남)/CA125(여) - 간암, 대장암, 췌장암, 전립선/난소암)",
                                                "간장질환(간기능) 검사 (AST, ALT, r-GTP, 총단백, 알부민, 총빌리루빈, ALP, LD - 간질환, 지방간, 알콜성 간장애 등)",
                                                "신장기능 검사 (BUN, Creatinine, e-GFR, 요산 - 신장질환, 신기능 평가, 통풍)",
                                                "전해질 및 무기질 검사 (Na, K, Cl, Ca, P - 전해질 및 무기질 대사)",
                                                "빈혈 및 혈액질환 검사 (WBC, RBC, Hb, Hct, MCV, MCH, MCHC, RDW, PLT, ABO/Rh - 빈혈, 백혈병, 감염증, 혈액형 확인 등)",
                                                "성질환/간염 검사 (매독, 에이즈, B형간염 항원/항체, C형간염 항체 - 성질환 및 간염 감염 여부)",
                                                "갑상선/영양 검사 (TSH, Free-T4, 비타민D - 갑상선 기능 항진/저하증, 비타민D 농도 확인)"
                                            ],
                                            "소변 및 기타": [
                                                "소변검사 (17종: 요단백, 요당, 요잠혈, pH 등 - 신장 및 요로계 질환)",
                                                "자궁경부암검사 (자궁경부암 정밀 선별검사)",
                                                "건강컨설팅 (검진 결과 판정 및 생활습관 가이드)"
                                            ]
                                        }
                                    },
                                    { 
