                        ...
                        categories: [
                            {
                                ...
                                icon: "fa-clipboard-check",
                                programs: [
                                    { title: "기본종합검진", items: "세브란스병원의 가장 표준적인 종합 건강검진 프로그램입니다." },
                                    { title: "프리미엄검진", items: "심층적인 검사와 전문의 상담이 포함된 프리미엄 프로그램입니다." },
                                    { title: "플래티넘검진", items: "최첨단 장비를 활용하여 전신을 정밀하게 체크하는 고품격 프로그램입니다." },
                                    { title: "노블레스검진", items: "세브란스병원이 제공하는 최고 사양의 맞춤형 건강검진 프로그램입니다." }
                                ]
                            }
                        ]
                    },
