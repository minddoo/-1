                                    ...
                                    { 
                                        ...
                                        details: {
                                            "기본 검사": [
                                                ...
                                                "신체계측 (신장, 체중, 허리둘레, 비만도 - 기초체력 분석)",
                                                "체성분 측정 (체내 골격근, 지방량, 신체균형, 내장지방 평가)",
                                                "혈압 및 맥박 (고혈압, 저혈압, 빈맥, 서맥)"
                                            ],
                                            "장비 검사": [
                                                "복부 초음파 (간, 담낭, 신장, 비장, 췌장 - 간암, 간경화, 지방간, 담석증, 췌장염 등)",
                                                "위내시경 (위암, 위궤양, 위염, 헬리코박터균, 식도암 등) ※ 수면 선택시 50,000원 추가",
                                                "골밀도 검사 (골량감조, 골다공증)",
                                                "흉부 X-ray 촬영 (폐암, 폐결핵, 폐렴, 기관지염 등)",
                                                "폐기능 검사 (폐의 기도저항, 기관지 협착, 폐기종 등)",
                                                "안과 검사 (시력, 안저촬영, 안압측정 - 녹내장, 백내장, 시신경염 등)",
                                                "심전도 (EKG - 부정맥, 협심증, 심근경색 등)",
                                                "청력정밀 (난청, 청력관련 정밀검사)",
                                                "구강검사 (치주질환 및 충치)"
                                            ],
                                            "혈액 검사": [
                                                "바이러스 검사 (A형간염 항체, B형간염 항원/항체)",
                                                "간 기능 검사 (간장질환 혈액검사 - 황달, 급만성간염, 지방간 등)",
                                                "혈액 질환 검사 (일반혈액질환 - 빈혈, 백혈병, 감염 등)",
                                                "심혈관계 검사 (중성지방 혈액검사 - 동맥경화, 이상지질혈증 등)",
                                                "당뇨 검사 (당뇨질환 혈액검사)",
                                                "신장 기능 검사 (신기능장애, 신부전증, 요독증 등)",
                                                "관절염 및 통풍 (요산, 류마티스 인자 - 통풍성 관절염, 전해질 대사이상)",
                                                "갑상선 기능 검사 (Free T4, TSH - 항진증 또는 저하증)",
                                                "종양표지자검사 (AFP, CEA, CA-125(여), PSA(남) - 간암, 대장암, 췌장암, 난소암, 전립선암 등)",
                                                "매독 반응 검사 (매독 감염여부)"
                                            ],
                                            "여성/남성 검사": [
                                                "유방 X-ray 촬영 (유방암, 섬유선종, 낭종성 변화, 석회화 등)",
                                                "자궁 도말 세포진 (자궁경부암, 염증 등)"
                                            ],
                                            "소변 검사": [
                                                "뇨침사검경 (신장, 당뇨, 요로감염, 비뇨기계 질환 등)"
                                            ]
                                        }
                                    },
                                    { title: "브론즈 (Bronze)", details: { "알림": ["항목 준비 중입니다."] } },
                                    { title: "실버 (Silver)", details: { "알림": ["항목 준비 중입니다."] } },
                                    { title: "골드 (Gold)", details: { "알림": ["항목 준비 중입니다."] } },
                                    { title: "플래티늄 (Platinum)", details: { "알림": ["항목 준비 중입니다."] } }
                                ]
                            }
                        ]
                    },
